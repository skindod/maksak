                                                        ...
                                                        <div class="kt-form__section kt-form__section--first">
                                                            <div class="kt-wizard-v2__form">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="event_name" placeholder="" value="" required="">
                                                        ...
                                                        <div class="kt-form__section kt-form__section--first">
                                                            <div class="kt-wizard-v2__form">
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="location_name" placeholder="" required="">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" name="location_address" rows="3"></textarea>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group">
                                                                            <label>Bandar</label>
                                                                            <input type="text" class="form-control" name="location_city" placeholder="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-lg-12 col-md-9 col-sm-12">
                                                                        ...
                                                                        <div class='input-group' id='kt_daterangepicker_2'>
                                                                            <input type='text' class="form-control" readonly name="location_date_range" required=""/>
                                                                            ...
                                                                            <div data-repeater-item class="form-group row align-items-center" style="margin-top:20px !important; background-color: #F4F6F9; border-radius: 5px; padding: 15px;">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="kt-form__group--inline">
                                                                                        <div class="kt-form__label">
                                                                                            <label class="kt-label m-label--single" style="margin-bottom: 7px; margin-top: 35px; font-weight: bold;">
                                                                                                Bilangan Jantina (pemain sahaja)
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="d-md-none kt-margin-b-10"></div>
