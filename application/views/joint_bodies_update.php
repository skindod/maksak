...
<title>MAKSAK | Kemaskini Ahli Badan Gabungan</title><!-- comment -->
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                            ...
                            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                                <div class="kt-subheader__main">
                                    ...
                                    <span class="kt-subheader__desc">Kemaskini ahli badan gabungan</span>
                                </div>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                                            ...
                                            <div class="kt-portlet__body kt-portlet__body--fit">
                                                ...
                                                echo form_open("jointBodies/update/".$joint_body->id, $attributes); ?>
                                                    <div class="kt-portlet__body">
                                                        <div class="form-group form-group-last">
                                                            <div class="alert alert-secondary" role="alert">
                                                                <div class="alert-icon"><i class="flaticon-add kt-font-brand"></i></div>
                                                                <div class="alert-text">
                                                                    Borang ini akan mengemaskini ahli badan gabungan baru.
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="status" required="">
                                                                <option value="1" <?php if($joint_body->status == 1){ echo 'selected'; } ?>>Aktif</option>
                                                                <option value="0" <?php if($joint_body->status == 0){ echo 'selected'; } ?>>Tidak aktif</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" name="name" value="<?php echo $joint_body->name;?>" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>E-mel</label>
                                                            <input type="email" class="form-control" name="email" value="<?php echo $joint_body->email;?>" aria-describedby="emailHelp" required="" placeholder="Masukkan e-mel untuk kegunaan log masuk ke dashboard">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="phone" value="<?php echo $joint_body->phone;?>">
                                                        </div>
                                                        <div class="form-group form-group-last">
                                                            <label>Negeri</label>
                                                            <select class="form-control" name="state" required="">
                                                                ...
                                                                <?php if(count($state_list) > 0){ foreach($state_list as $state){ ?>
                                                                    <option value="<?php echo $state->id; ?>" <?php if($state->id == $joint_body->badan_gabungan_id){ echo 'selected'; } ?>><?php echo $state->name; ?></option>
                                                                <?php }} ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span class="kt-widget11__title">MAKSAK Selangor</span>
                                                                    </td>
                                                                    <td>
