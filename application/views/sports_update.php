                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                            ...
                            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                                <div class="kt-subheader__main">
                                    ...
                                    <span class="kt-subheader__desc">Sunting acara</span>
                                </div>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                                            ...
                                            <div class="kt-portlet__body kt-portlet__body--fit">
                                                ...
                                                echo form_open("sports/update/".$sport->id, $attributes); ?>
                                                    <div class="kt-portlet__body">
                                                        <div class="form-group form-group-last">
                                                            <div class="alert alert-secondary" role="alert">
                                                                <div class="alert-icon"><i class="flaticon-add kt-font-brand"></i></div>
                                                                <div class="alert-text">
                                                                    Borang ini akan menyunting acara anda.
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Nama acara</label>
                                                            <input type="text" class="form-control" name="name" placeholder="Nama acara atau sukan" value="<?php echo $sport->name;?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleTextarea">Penerangan tentang acara</label>
                                                            <textarea class="form-control" name="description" id="exampleTextarea" rows="3"><?php echo $sport->description;?></textarea>
                                                        </div>
<!--                                                        <div class="form-group form-group-last">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>0</td>
                                                                    <td><a href="<?php echo base_url(); ?>sports/update/<?php echo $sport->id; ?>" class="btn kt-subheader__btn-primary btn-icon"><i class="flaticon2-edit"></i></a></td>
                                                                </tr>
                                                                <?php }} ?>
                                                            </tbody>
                                                        </table>
