                                    ...
                                    <div class="col-xl-7">
                                        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                                            ...
                                            <div class="kt-portlet__body kt-portlet__body--fit">
                                                ...
                                                echo form_open_multipart("admins/create", $attributes); ?>
                                                    <div class="kt-portlet__body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="username" class="form-control" aria-describedby="username" name="name">
                                                                    </div>
                                                                    <div class="form-group form-group-last">
                                                                        <label>Taraf pengguna</label>
                                                                        <select class="form-control selectpicker" name="role">
                                                                            <option value="0">Setiausaha Agung (superadmin)</option>
                                                                            <option value="1">Pengurus Aplikasi (admin)</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" aria-describedby="userEmail" placeholder="eg: ren@gmail.com" name="email" required="">
